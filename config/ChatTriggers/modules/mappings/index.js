...
if (FileLib.read("mappings", "mappings.js") === null) {// Semisol was here
    console.log("Downloading mappings data...")
    // console.log("Downloading mappings data... (Constructors)")
    // FileLib.write("mappings", "data/joined.tsrg", FileLib.getUrlContent("https://mcp.thiakil.com/data/1.8.9/joined.tsrg"))
    console.log("Downloading mappings data... (fields)")
    FileLib.write("mappings", "data/fields.csv", FileLib.getUrlContent("http://soopy.dev/api/soopyv2/fields.csv"))
    // console.log("Downloading mappings data... (inheritance)")
    // FileLib.write("mappings", "data/joined.tsrg", FileLib.getUrlContent("https://mcp.thiakil.com/data/1.8.9/joined.tsrg"))
    console.log("Downloading mappings data... (joined)")
    FileLib.write("mappings", "data/joined.tsrg", FileLib.getUrlContent("http://soopy.dev/api/soopyv2/joined.tsrg"))
    console.log("Downloading mappings data... (methods)")
    FileLib.write("mappings", "data/methods.csv", FileLib.getUrlContent("http://soopy.dev/api/soopyv2/methods.csv"))
    console.log("Downloading mappings data... (params)")
    FileLib.write("mappings", "data/params.csv", FileLib.getUrlContent("http://soopy.dev/api/soopyv2/params.csv"))
...
module.exports = {m:m,f:f}`
    ...
    FileLib.write("mappings", "mappings.js", mappingsJs)
}